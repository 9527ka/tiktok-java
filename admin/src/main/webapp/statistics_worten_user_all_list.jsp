...
<%@ include file="include/head.jsp"%>
	...
	<style>
		...
		/*	position: sticky;*/
		/*	top: 0;*/
		/*	background-color: #f1f1f1; !* 你可以根据需要设置表头的背景色 *!*/
		/*}*/
	</style>
</head>
								...
								<thead class="sticky-header">
									<tr>
										...
										<td colspan="1" rowspan="3"
											style="text-align: center; vertical-align: middle;">赠送彩金</td>
										<td colspan="1" rowspan="3"
											style="text-align: center; vertical-align: middle;">店铺销售总额</td>
										<td colspan="1" rowspan="3"
											style="text-align: center; vertical-align: middle;">已发放佣金</td>
										<td colspan="1" rowspan="3"
											style="text-align: center; vertical-align: middle;">待发放金额</td>
<%--										<td colspan="1" rowspan="3"--%>
<%--											style="text-align: center; vertical-align: middle;">用户备注</td>--%>
...
<%--											<td>${item.sellerId}</td>--%>
											...
											<td><fmt:formatNumber value="${item.gift_money}" pattern="#0.0000" /></td>
											...
											<td><fmt:formatNumber value="${item.willIncome}" pattern="#0.0000" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
