...
<script type="text/javascript">
	...
	function modifyBlockChain(userename){
		location.href = '<%=basePath%>normal/adminChannelBlockchainAction!personList.action?username='+userename+'&from_page=agent';
	}
