							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									...
									<select id="login_authority" name="login_authority" class="form-control " >
										...
										<option value="false" <c:if test="${login_authority == 'false'}">selected="false"</c:if> >无</option>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									...
									<select id="opera_authority" name="opera_authority" class="form-control " >
										...
										<option value="false" <c:if test="${opera_authority == 'false'}">selected="false"</c:if> >无</option>
									</select>
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-2 control-label form-label">客服功能</label>
								<div class="col-sm-2">
									<%-- <s:select id="login_authority" cssClass="form-control "
                                        name="login_authority" list="#{true:'有权限',false:'无'}"
                                        listKey="key" listValue="value" value="login_authority" /> --%>
									<select id="call_flag" name="call_flag" class="form-control " >
										<option value="true" <c:if test="${callFlag == 'Y'}">selected="true"</c:if> >有</option>
										<option value="false" <c:if test="${callFlag == 'N'}">selected="false"</c:if> >无</option>
									</select>
								</div>
							</div>
