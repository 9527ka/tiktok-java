				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="<%=basePath%>normal/adminCmsAction!update.action"
							...
							<div class="form-group">
								<label class="col-sm-1 control-label form-label">店铺账号(选填，多个请用,隔开)</label>
								<div class="col-sm-10">
									<input id="store_account" name="store_account" class="form-control" value="${cms.storeAccount}"/>
								</div>
							</div>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input id="google_auth_code" name="google_auth_code" class="google_auth_code"
