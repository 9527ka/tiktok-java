					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminChannelBlockchainAction!personUpdate.action"
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
									${entity.coinSymbol}
										<input id="coin" name="coin" cssClass="form-control" style="display:none" value="${entity.coinSymbol}" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
									${entity.chainName}
										<input id="blockchain_name" name="blockchain_name" cssClass="form-control " style="display:none" value="${entity.chainName}"/>
									</div>
								</div>
