						...
						<div class="panel-body">
							<form class="form-horizontal"
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
									${entity.coin}
										<input id="coin" name="coin" cssClass="form-control" style="display:none" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
									${entity.blockchain_name}
										<input id="blockchain_name" name="blockchain_name" cssClass="form-control " style="display:none" />
									</div>
								</div>
